const slides = [
  {
    ...
    content: `
            <div class="social-auth-content">
                ...
                <div class="social-auth-info">
                    <h3 class="slide-title">Social Authentication en PHP</h3>
                    <p>
                        L'autenticació social permet als usuaris iniciar sessió a la teva aplicació
                        utilitzant les seves credencials de xarxes socials com Google, Facebook,
                        Twitter, GitHub, etc.
                    </p>

                    <div class="social-auth-topics">
                        <div class="social-auth-topic">
                            <h4>🔑 Què és OAuth?</h4>
  ...
  {
    title: "2. Configuració OAuth",
    content: `
            <h2 class="slide-title">2. Configuració OAuth</h2>
            <p>Contingut en desenvolupament...</p>
        `
  },
  {
    title: "3. Implementació HybridAuth",
    content: `
            <h2 class="slide-title">3. Implementació HybridAuth</h2>
            <p>Contingut en desenvolupament...</p>
        `
  },
  {
    title: "4. Proveïdors més comuns",
    content: `
            <h2 class="slide-title">4. Proveïdors més comuns</h2>
            <p>Contingut en desenvolupament...</p>
        `
  },
  {
    title: "5. Base de dades i usuaris",
    content: `
            <h2 class="slide-title">5. Base de dades i usuaris</h2>
            <p>Contingut en desenvolupament...</p>
        `
  },
  {
    title: "6. Seguretat i tokens",
    content: `
            <h2 class="slide-title">6. Seguretat i tokens</h2>
            <p>Contingut en desenvolupament...</p>
        `
  },
  {
    title: "7. Casos pràctics",
    content: `
            <h2 class="slide-title">7. Casos pràctics</h2>
            <p>Contingut en desenvolupament...</p>
        `
  },
  {
    title: "8. Problemes comuns",
    content: `
            <h2 class="slide-title">8. Problemes comuns</h2>
            <p>Contingut en desenvolupament...</p>
        `
  },
  {
    title: "9. Millores i alternatives",
    content: `
            <h2 class="slide-title">9. Millores i alternatives</h2>
            <p>Contingut en desenvolupament...</p>
        `
  }
];
